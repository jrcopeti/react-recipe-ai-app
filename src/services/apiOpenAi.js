  ...
  parameters: {
    ...
    properties: {
      ...
      query: {
        type: "string",
        description:
          "One or two maximum key word, that has to include a cooking method that can be used as query to the Unsplash API to get an image related to the recipe for the dish",
      },
    },
